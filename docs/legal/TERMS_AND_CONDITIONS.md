...
**You** ("User," "Customer," "you," or "your") – the individual or business entity accessing or using the Service
...
- Effective 30 days after posting (unless required sooner by law)
...
| **Business Entity** | A company, partnership, or sole proprietorship registered under Nigerian law |
| **Confidential Information** | Non-public information disclosed by either party |
| **Content** | Data, text, documents, images, or other materials |
...
- **Financial Tracking:** Income, expense, and transaction recording
- **Inventory Management:** Stock tracking and write-off management
- **Reporting:** Financial reports and TaxPro Max exports
- **Multi-Entity Support:** Management of multiple business entities
- **Payroll:** PAYE calculation and employee management
...
- **Emergency Maintenance:** May occur without notice to address critical issues

### 3.3 Service Limitations

The Service is designed for use within Nigeria and compliance with Nigerian tax laws. We do not guarantee suitability for:
- Jurisdictions outside Nigeria
- Tax regimes other than Nigerian federal and state taxes
- Industries with specialized regulatory requirements not covered
...
- Provide valid business information including TIN
...
### 4.4 Multiple Users and Access Control

- You may grant access to employees, accountants, or auditors
- You are responsible for managing user permissions
- You must remove access for terminated employees promptly
- We are not liable for actions taken by your authorized users
...
|------|----------|---------|
| **Free Trial** | Limited features, 14 days | No charge |
| **Starter** | Basic compliance features | Monthly/Annual |
| **Professional** | Full features for small businesses | Monthly/Annual |
| **Business** | Advanced features, multi-entity | Monthly/Annual |
...
- **Payment Methods:** Bank transfer, card payment, mobile money
- **Billing Cycle:** Monthly or annual, based on your selection
- **Due Date:** Payment is due at the start of each billing period
- **Late Payment:** Access may be suspended after 7 days overdue

### 5.4 Refunds

- **Annual Subscriptions:** Pro-rata refund within first 30 days
- **Monthly Subscriptions:** No refund for partial months
- **Service Issues:** Refunds may be provided at our discretion for documented service failures
- **Chargebacks:** Disputed charges without prior contact may result in account suspension
...
**Illegal Activities:**
- Use the Service for tax evasion or fraud
- Submit false information to NRS or other authorities
...
- Use the Service to collect personal data of others without consent
- Upload illegal, offensive, or harmful content

### 6.3 Compliance with Tax Laws

While we provide compliance tools, you remain responsible for:
- Accuracy of data entered into the Service
...
You are granted a limited, non-exclusive, non-transferable license to use the Service for your internal business purposes only.
...
You retain ownership of all User Data you input into the Service. By using the Service, you grant us a limited license to:
- Store, process, and display your User Data to provide the Service
- Generate aggregated, anonymized analytics (no personally identifiable information)
- Create backups for disaster recovery purposes

### 7.4 Feedback

If you provide suggestions, ideas, or feedback about the Service, we may use them without obligation to compensate you.
...
Our collection and use of personal data is governed by our [Privacy Policy](PRIVACY_POLICY.md), which is incorporated into these Terms by reference.

### 8.2 Data Processing

By using the Service, you acknowledge that:
- We process User Data to provide the Service
- Data may be shared with NRS for e-invoicing compliance
- We use third-party service providers for hosting and processing
...
Under the Nigeria Data Protection Act 2023, you have rights to access, correct, delete, and port your data. See our Privacy Policy for details.

---

## 9. NRS Integration and E-Invoicing

### 9.1 E-Invoicing Compliance

The Service integrates with the Nigeria Revenue Service (NRS) for e-invoicing. By using this feature:
- You authorize us to submit invoices to NRS on your behalf
- You confirm the accuracy of invoice information
- You understand invoices become final after the 72-hour window

### 9.2 IRN and QR Codes

- Invoice Reference Numbers (IRN) are generated by NRS
- QR codes are embedded as required by law
- We are not responsible for NRS system availability

### 9.3 Liability for Submissions

- **Your Responsibility:** Accuracy of invoice data
- **Our Responsibility:** Proper transmission to NRS
- **NRS Responsibility:** Processing and validation

We are not liable for penalties resulting from inaccurate data you provide.
...
- Nigerian banks (for bank feeds)
- NRS and state tax authorities
- OCR service providers
- Payment processors

### 10.2 Third-Party Terms

Use of third-party services is subject to their respective terms and privacy policies. We are not responsible for third-party service availability or conduct.

### 10.3 Third-Party Links

The Service may contain links to third-party websites. We do not endorse or control these sites and are not responsible for their content or practices.
...
- Legal advice
- Accounting advice
- Assurance that tax calculations are correct for your specific situation

Always consult qualified tax and legal professionals for advice.

### 11.3 No Guarantee of Compliance

While we design the Service to support compliance with Nigerian tax laws:
...
We do not guarantee the availability, accuracy, or performance of:
- NRS e-invoicing systems
- Bank APIs
...
- ₦500,000 (Five Hundred Thousand Naira), whichever is greater
...
- The limitations are fundamental to the agreement between us
...
- Inaccurate data you submit through the Service
- Penalties or fines imposed on us due to your actions

### 13.2 Procedure

- We will notify you promptly of any claim
- You will have control of the defense (with our approval of counsel)
- We may participate in the defense at our expense
- You will not settle claims without our written consent
...
- Deleting your account (subject to data retention requirements)

### 14.3 Termination by Us

We may suspend or terminate your access:
- **Immediately** for violation of these Terms
- **Immediately** for illegal activity or fraud
- **With 30 days' notice** for discontinuation of the Service
...
- We will provide data export options for 30 days
- Provisions that by nature should survive will remain in effect

### 14.5 Survival

The following sections survive termination: 7 (IP), 10 (Disclaimers), 11 (Limitation of Liability), 12 (Indemnification), 15 (Governing Law), and 16 (Dispute Resolution).
...
If informal resolution fails, either party may initiate mediation under the Lagos Multi-Door Courthouse rules.

### 16.3 Arbitration

Disputes not resolved through mediation shall be settled by binding arbitration:
- **Rules:** Lagos Court of Arbitration Rules
- **Location:** Lagos, Nigeria
- **Language:** English
- **Arbitrators:** One arbitrator mutually agreed upon

### 16.4 Court Jurisdiction

Notwithstanding the above, either party may seek:
- Injunctive relief in any court of competent jurisdiction
- Enforcement of arbitral awards

The courts of Lagos State, Nigeria shall have exclusive jurisdiction for matters not subject to arbitration.
...
These Terms, together with the Privacy Policy and any order forms, constitute the entire agreement between you and us regarding the Service.
...
We are not liable for delays or failures caused by events beyond our reasonable control, including natural disasters, war, terrorism, pandemics, or government actions.
...
These Terms are in English. In case of translation, the English version prevails.
