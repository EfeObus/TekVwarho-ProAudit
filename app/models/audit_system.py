"""
TekVwarho ProAudit - Advanced Audit System Models

This module provides database models for the world-class audit system:
...
- AuditSession: Auditor access sessions with complete logging
...
class AuditorAction(str, enum.Enum):
...
class AuditorSession(Base):
    ...
    actions: Mapped[List["AuditorAction"]] = relationship(
        "AuditorActionLog",
...
class AuditorActionLog(Base):
    ...
    # Action Details
    action: Mapped[AuditorAction] = mapped_column(
        Enum(AuditorAction),
        nullable=False,
        index=True,
    )
